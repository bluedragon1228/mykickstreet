...
export default function ProductCard() {
  const [details,setDetails] = useState<Product>({description:'',gender:'',images:[''],name:'aa',offer:0,price:0,rating:0,reviews:[''],sale:false,size:[],stock:0})
