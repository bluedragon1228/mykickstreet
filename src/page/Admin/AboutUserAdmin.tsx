  ...
  return (
    ...
    <section className="adminPage bg-white text-black flex pt-12 flex-col justify-start items-center">
      ...
      <div className='flex justify-center w-11/12 '>
        <div className=' w-5/6 mx-5  flex flex-col items-center justify-start'>
            ...
            <div className='w-full border rounded-lg my-3'>
              ...
              {data?.orders.map(e=>
                  <div className='border-b hover:bg-gray-50 flex   justify-evenly h-16 items-center '>
                    <p className='w-2/5 underline text-start pl-4 cursor-pointer hover:text-indigo-700'>#<Link to={`/admin/orders/${e._id}`}>{e._id}</Link></p>
        ...
        <div className='w-2/6 px-5 my-10'>
